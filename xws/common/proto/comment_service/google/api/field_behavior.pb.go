...
// 	protoc        v3.20.1
// source: common/proto/comment_service/google/api/field_behavior.proto
...
func (FieldBehavior) Descriptor() protoreflect.EnumDescriptor {
	return file_common_proto_comment_service_google_api_field_behavior_proto_enumTypes[0].Descriptor()
}

func (FieldBehavior) Type() protoreflect.EnumType {
	return &file_common_proto_comment_service_google_api_field_behavior_proto_enumTypes[0]
}
...
func (FieldBehavior) EnumDescriptor() ([]byte, []int) {
	return file_common_proto_comment_service_google_api_field_behavior_proto_rawDescGZIP(), []int{0}
}

var file_common_proto_comment_service_google_api_field_behavior_proto_extTypes = []protoimpl.ExtensionInfo{
	{
		...
		Filename:      "common/proto/comment_service/google/api/field_behavior.proto",
	},
}
...
var (
	...
	E_FieldBehavior = &file_common_proto_comment_service_google_api_field_behavior_proto_extTypes[0]
)

var File_common_proto_comment_service_google_api_field_behavior_proto protoreflect.FileDescriptor

var file_common_proto_comment_service_google_api_field_behavior_proto_rawDesc = []byte{
	0x0a, 0x3c, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x63,
...
var (
	file_common_proto_comment_service_google_api_field_behavior_proto_rawDescOnce sync.Once
	file_common_proto_comment_service_google_api_field_behavior_proto_rawDescData = file_common_proto_comment_service_google_api_field_behavior_proto_rawDesc
)

func file_common_proto_comment_service_google_api_field_behavior_proto_rawDescGZIP() []byte {
	file_common_proto_comment_service_google_api_field_behavior_proto_rawDescOnce.Do(func() {
		file_common_proto_comment_service_google_api_field_behavior_proto_rawDescData = protoimpl.X.CompressGZIP(file_common_proto_comment_service_google_api_field_behavior_proto_rawDescData)
	})
	return file_common_proto_comment_service_google_api_field_behavior_proto_rawDescData
}

var file_common_proto_comment_service_google_api_field_behavior_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_common_proto_comment_service_google_api_field_behavior_proto_goTypes = []interface{}{
	(FieldBehavior)(0),                // 0: google.api.FieldBehavior
	(*descriptorpb.FieldOptions)(nil), // 1: google.protobuf.FieldOptions
}
var file_common_proto_comment_service_google_api_field_behavior_proto_depIdxs = []int32{
...
func init() { file_common_proto_comment_service_google_api_field_behavior_proto_init() }
func file_common_proto_comment_service_google_api_field_behavior_proto_init() {
	if File_common_proto_comment_service_google_api_field_behavior_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_common_proto_comment_service_google_api_field_behavior_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   0,
			NumExtensions: 1,
			NumServices:   0,
		},
		GoTypes:           file_common_proto_comment_service_google_api_field_behavior_proto_goTypes,
		DependencyIndexes: file_common_proto_comment_service_google_api_field_behavior_proto_depIdxs,
		EnumInfos:         file_common_proto_comment_service_google_api_field_behavior_proto_enumTypes,
		ExtensionInfos:    file_common_proto_comment_service_google_api_field_behavior_proto_extTypes,
	}.Build()
	File_common_proto_comment_service_google_api_field_behavior_proto = out.File
	file_common_proto_comment_service_google_api_field_behavior_proto_rawDesc = nil
	file_common_proto_comment_service_google_api_field_behavior_proto_goTypes = nil
	file_common_proto_comment_service_google_api_field_behavior_proto_depIdxs = nil
}
